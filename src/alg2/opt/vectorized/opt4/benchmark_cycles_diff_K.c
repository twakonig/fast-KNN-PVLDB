...
void benchmarkAlg2Opt4() {
    ...
    for(int it = 0; it < NUM_WARMUP; ++it ) {
        ...
        knn_mc_approximation(&sp_approx, &x_trn, y_trn, &x_tst, y_tst, K, T);
    }
...
int main(int argc, char **argv) {
    ...
    if (argc!=6) {printf("Incorrect number of arguments, please use (n) (K) (T) (seed) (num_runs).\n"); return -1;}
