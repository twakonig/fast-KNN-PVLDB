...
def createRuntimePlot(N, base, baseO3, y_1, y_2, y_3, y_4, flags, name):
    ...
    plt.plot(N, y_4, marker='o', ms=7, c='darkblue', linewidth=2.2, linestyle='solid', label='l2-norm + heap (iterative) + col_mean + knn_utility (inlining)')
    ...
    plt.savefig('./plots/runtime/a2_scalar_opts_' + name + '.pdf')
...
createRuntimePlot(N, t_base, t_baseO3, t_o1, t_o2, t_o3, t_o4, flags_scalar_O3_ffm, 'O3_ffm')
