...
# executables
flags0=("./no-flags-shuffle" "./O3-novec-shuffle" "./O3-vec-shuffle")
...
## mode 0: scalar implementation; mode 1: SIMD implementation
#mode1=1
#flags1=("./no-flags-shuffle" "./O3-vec-shuffle" "./O3-SIMD")
#
#
...
#mode2=2
## executables
#flags2=("./no-flags-colmean" "./O3-novec-colmean" "./O3-vec-colmean")
#
#
## for scalar implementation
