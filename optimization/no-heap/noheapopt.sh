...
# executables
flags0=("./no-flags-no-heap" "./O3-novec-no-heap" "./O3-vec-no-heap")
...
## mode 0: scalar implementation; mode 1: SIMD implementation
#mode1=1
#flags1=("./no-flags-no-heap" "./O3-vec-no-heap" "./O3-SIMD")
#
#
...
#mode2=2
## executables
#flags2=("./no-flags-no-heap" "./O3-novec-no-heap" "./O3-vec-no-heap")
#
#
## for scalar implementation
