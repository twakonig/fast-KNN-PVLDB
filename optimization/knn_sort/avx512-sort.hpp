...
/// Int
    ...
    inline void CoreSmallSort(__m512 &input, __m512 values) {
        {
            ...
            values = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, values),
    ...
    inline void CoreSmallSort(float *__restrict__ ptr1, int *__restrict__ ptrVal) {
        __m512i v = _mm512_loadu_ps(ptr1);
        __m512i v_val = _mm512_loadu_si512(ptrVal);
        CoreSmallSort(v, v_val);
        _mm512_storeu_ps(ptr1, v);
        _mm512_storeu_si512(ptrVal, v_val);
    }


    inline void CoreExchangeSort2V(__m512 &input, __m512 &input2,
        ...
        }
        {
            ...
            input_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input_val),
                                              _mm512_cmp_epi32_mask(tmp_input, input, _MM_CMPINT_EQ),
                                              input_val);
            input2_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input2_val),
    ...
    inline void CoreSmallSort2(__m512 &input, __m512 &input2,
                               __m512i &input_val, __m512i &input2_val) {
        {
            __m512i idxNoNeigh = _mm512_set_epi32(14, 15, 12, 13, 10, 11, 8, 9,
                                                  6, 7, 4, 5, 2, 3, 0, 1);
    ...
    inline void CoreSmallSort2(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input1 = _mm512_loadu_ps(ptr1);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 16);
        ...
        _mm512_storeu_ps(ptr1, input1);
        _mm512_storeu_ps(ptr1 + 16, input2);
        _mm512_storeu_si512(values, input1_val);
        _mm512_storeu_si512(values + 16, input2_val);
    }


    inline void CoreSmallSort3(__m512 &input, __m512 &input2, __m512 &input3,
        ...
        }
        {
            ...
            input2_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input2_val),
                                               _mm512_cmp_epi32_mask(tmp_input2, input2, _MM_CMPINT_EQ),
                                               input2_val);
            input3_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input3_val),
    ...
    inline void CoreSmallSort3(int *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input1 = _mm512_loadu_ps(ptr1);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 32);
        __m512i input1_val = _mm512_loadu_si512(values);
        __m512i input2_val = _mm512_loadu_si512(values + 16);
        ...
        _mm512_storeu_ps(ptr1, input1);
        _mm512_storeu_ps(ptr1 + 16, input2);
        _mm512_storeu_ps(ptr1 + 32, input3);
        _mm512_storeu_si512(values, input1_val);
        _mm512_storeu_si512(values + 16, input2_val);
    ...
    inline void CoreSmallSort4(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
        ...
        }
        {
            ...
            input3_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input3_val),
                                               _mm512_cmp_epi32_mask(tmp_input3, input3, _MM_CMPINT_EQ),
                                               input3_val);
            input4_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input4_val),
                                               _mm512_cmp_epi32_mask(tmp_input4, input4, _MM_CMPINT_EQ),
                                               input4_val);
    ...
    inline void CoreSmallSort4(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input1 = _mm512_loadu_ps(ptr1);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 32);
        __m512 input4 = _mm512_loadu_ps(ptr1 + 48);
        __m512i input1_val = _mm512_loadu_si512(values);
        __m512i input2_val = _mm512_loadu_si512(values + 16);
        __m512i input3_val = _mm512_loadu_si512(values + 32);
        ...
        _mm512_storeu_ps(ptr1 + 16, input2);
        _mm512_storeu_ps(ptr1 + 32, input3);
        _mm512_storeu_ps(ptr1 + 48, input4);
        _mm512_storeu_si512(values, input1_val);
        _mm512_storeu_si512(values + 16, input2_val);
        _mm512_storeu_si512(values + 32, input3_val);
    ...
    inline void CoreSmallSort5(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4, __m512 &input5,
                               __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                               __m512i &input5_val) {
        ...
        CoreSmallSort(input5, input5_val);
        {
            ...
            input5_val = _mm512_mask_mov_epi32(input4_val, _mm512_cmp_epi32_mask(tmp_input5, permNeigh5, _MM_CMPINT_EQ),
                                               input5_val_copy);
            input4_val = _mm512_mask_mov_epi32(input5_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input4, input4, _MM_CMPINT_EQ),
                                               input4_val);
        ...
        }
        {
            ...
            input2_val = _mm512_mask_mov_epi32(input4_val, _mm512_cmp_epi32_mask(tmp_input2, inputCopy, _MM_CMPINT_EQ),
                                               input2_val_copy);
            input4_val = _mm512_mask_mov_epi32(input2_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input4, input4, _MM_CMPINT_EQ),
                                               input4_val);
        ...
        }
        {
            ...
            input4_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input4_val),
                                               _mm512_cmp_epi32_mask(tmp_input4, input4, _MM_CMPINT_EQ),
                                               input4_val);
            input5_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input5_val),
    ...
    inline void CoreSmallSort5(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input1 = _mm512_loadu_ps(ptr1);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input4 = _mm512_loadu_ps(ptr1 + 3 * 16);
        __m512 input5 = _mm512_loadu_ps(ptr1 + 4 * 16);
        __m512i input1_val = _mm512_loadu_si512(values);
        ...
        _mm512_storeu_ps(ptr1, input1);
        _mm512_storeu_ps(ptr1 + 1 * 16, input2);
        _mm512_storeu_ps(ptr1 + 2 * 16, input3);
        _mm512_storeu_ps(ptr1 + 3 * 16, input4);
        _mm512_storeu_ps(ptr1 + 4 * 16, input5);
        _mm512_storeu_si512(values, input1_val);
    ...
    inline void CoreSmallSort6(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                               __m512 &input5, __m512 &input6,
                               __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
        ...
        CoreSmallSort2(input5, input6, input5_val, input6_val);
        {
            ...
            input5_val = _mm512_mask_mov_epi32(input4_val, _mm512_cmp_epi32_mask(tmp_input5, permNeigh5, _MM_CMPINT_EQ),
                                               input5_val_perm);
            input4_val = _mm512_mask_mov_epi32(input5_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input4, input4, _MM_CMPINT_EQ),
                                               input4_val);
            ...
            input6_val = _mm512_mask_mov_epi32(input3_val, _mm512_cmp_epi32_mask(tmp_input6, permNeigh6, _MM_CMPINT_EQ),
                                               input6_val_perm);
            input3_val = _mm512_mask_mov_epi32(input6_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input3, input3, _MM_CMPINT_EQ),
                                               input3_val);
        ...
        }
        {
            ...
            input5_val = _mm512_mask_mov_epi32(input6_val, _mm512_cmp_epi32_mask(tmp_input5, inputCopy, _MM_CMPINT_EQ),
                                               input5_val_copy);
            input6_val = _mm512_mask_mov_epi32(input5_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input6, input6, _MM_CMPINT_EQ),
                                               input6_val);
        ...
        }
        {
            ...
            input5_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input5_val),
                                               _mm512_cmp_epi32_mask(tmp_input5, input5, _MM_CMPINT_EQ),
                                               input5_val);
            input6_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input6_val),
                                               _mm512_cmp_epi32_mask(tmp_input6, input6, _MM_CMPINT_EQ),
                                               input6_val);
    ...
    inline void CoreSmallSort6(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        __m512 input4 = _mm512_loadu_ps(ptr1 + 4 * 16);
        __m512 input5 = _mm512_loadu_ps(ptr1 + 5 * 16);
        ...
        _mm512_storeu_ps(ptr1 + 0 * 16, input0);
        _mm512_storeu_ps(ptr1 + 1 * 16, input1);
        _mm512_storeu_ps(ptr1 + 2 * 16, input2);
        _mm512_storeu_ps(ptr1 + 3 * 16, input3);
        _mm512_storeu_ps(ptr1 + 4 * 16, input4);
        _mm512_storeu_ps(ptr1 + 5 * 16, input5);
    ...
    inline void CoreSmallSort7(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                               __m512 &input5, __m512 &input6, __m512 &input7,
                               __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                       ...
                       input5_val, input6_val, input7_val);
        {
            ...
            input7_val = _mm512_mask_mov_epi32(input2_val, _mm512_cmp_epi32_mask(tmp_input7, permNeigh7, _MM_CMPINT_EQ),
                                               input7_val_perm);
            input2_val = _mm512_mask_mov_epi32(input7_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input2, input2, _MM_CMPINT_EQ),
                                               input2_val);
        ...
        }
        {
            ...
            input5_val = _mm512_mask_mov_epi32(input7_val, _mm512_cmp_epi32_mask(tmp_input5, inputCopy, _MM_CMPINT_EQ),
                                               input5_val_copy);
            input7_val = _mm512_mask_mov_epi32(input5_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input7, input7, _MM_CMPINT_EQ),
                                               input7_val);
        ...
        }
        {
            ...
            input6_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input6_val),
                                               _mm512_cmp_epi32_mask(tmp_input6, input6, _MM_CMPINT_EQ),
                                               input6_val);
            input7_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input7_val),
                                               _mm512_cmp_epi32_mask(tmp_input7, input7, _MM_CMPINT_EQ),
                                               input7_val);
    ...
    inline void CoreSmallSort7(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        __m512 input4 = _mm512_loadu_ps(ptr1 + 4 * 16);
        __m512 input5 = _mm512_loadu_ps(ptr1 + 5 * 16);
        __m512 input6 = _mm512_loadu_ps(ptr1 + 6 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        _mm512_storeu_ps(ptr1 + 4 * 16, input4);
        _mm512_storeu_ps(ptr1 + 5 * 16, input5);
        _mm512_storeu_ps(ptr1 + 6 * 16, input6);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort8(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                               __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                               __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
        ...
        }
        {
            ...
            input6_val = _mm512_mask_mov_epi32(input8_val, _mm512_cmp_epi32_mask(tmp_input6, inputCopy, _MM_CMPINT_EQ),
                                               input6_val_copy);
            input8_val = _mm512_mask_mov_epi32(input6_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input8, input8, _MM_CMPINT_EQ),
                                               input8_val);
        ...
        }
        {
            ...
            input7_val = _mm512_mask_mov_epi32(input8_val, _mm512_cmp_epi32_mask(tmp_input7, inputCopy, _MM_CMPINT_EQ),
                                               input7_val_copy);
            input8_val = _mm512_mask_mov_epi32(input7_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input8, input8, _MM_CMPINT_EQ),
                                               input8_val);
        ...
        }
        {
            ...
            input7_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input7_val),
                                               _mm512_cmp_epi32_mask(tmp_input7, input7, _MM_CMPINT_EQ),
                                               input7_val);
            input8_val = _mm512_mask_mov_epi32(_mm512_permutexvar_epi32(idxNoNeigh, input8_val),
                                               _mm512_cmp_epi32_mask(tmp_input8, input8, _MM_CMPINT_EQ),
                                               input8_val);
    ...
    inline void CoreSmallSort8(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0 = _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input5 = _mm512_loadu_ps(ptr1 + 5 * 16);
        __m512 input6 = _mm512_loadu_ps(ptr1 + 6 * 16);
        __m512 input7 = _mm512_loadu_ps(ptr1 + 7 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        _mm512_storeu_ps(ptr1 + 5 * 16, input5);
        _mm512_storeu_ps(ptr1 + 6 * 16, input6);
        _mm512_storeu_ps(ptr1 + 7 * 16, input7);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallEnd1(__m512 &input, __m512i values) {
        {
            __m512i idxNoNeigh = _mm512_set_epi32(7, 6, 5, 4, 3, 2, 1, 0,
                                                  15, 14, 13, 12, 11, 10, 9, 8);
            __m512i permNeigh = _mm512_permutexvar_epi32(idxNoNeigh, input);
    ...
    inline void CoreSmallEnd2(__m512 &input, __m512 &input2,
                              __m512i &input_val, __m512i &input2_val) {
        {
            __m512i inputCopy = input;
            __m512i tmp_input = _mm512_min_epi32(input2, inputCopy);
    ...
    inline void CoreSmallEnd3(__m512 &input, __m512 &input2, __m512 &input3,
                              __m512i &input_val, __m512i &input2_val, __m512i &input3_val) {
        {
            __m512i inputCopy = input;
            __m512i tmp_input = _mm512_min_epi32(input3, inputCopy);
    ...
    inline void CoreSmallEnd4(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                              __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val) {
        {
            __m512i inputCopy = input;
            __m512i tmp_input = _mm512_min_epi32(input3, inputCopy);
    ...
    inline void CoreSmallEnd5(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                              __m512 &input5,
                              __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                              __m512i &input5_val) {
        {
    ...
    inline void CoreSmallEnd6(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                              __m512 &input5, __m512 &input6,
                              __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                              __m512i &input5_val, __m512i &input6_val) {
        {
        ...
        }
        {
            ...
            input2_val = _mm512_mask_mov_epi32(input6_val, _mm512_cmp_epi32_mask(tmp_input2, inputCopy, _MM_CMPINT_EQ),
                                               input2_val_copy);
            input6_val = _mm512_mask_mov_epi32(input2_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input6, input6, _MM_CMPINT_EQ),
                                               input6_val);
    ...
    inline void CoreSmallEnd7(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                              __m512 &input5, __m512 &input6, __m512 &input7,
                              __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                              __m512i &input5_val, __m512i &input6_val, __m512i &input7_val) {
        {
        ...
        }
        {
            ...
            input3_val = _mm512_mask_mov_epi32(input7_val, _mm512_cmp_epi32_mask(tmp_input3, inputCopy, _MM_CMPINT_EQ),
                                               input3_val_copy);
            input7_val = _mm512_mask_mov_epi32(input3_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input7, input7, _MM_CMPINT_EQ),
                                               input7_val);
    ...
    inline void CoreSmallEnd8(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                              __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                              __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                              __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val) {
        {
        ...
        }
        {
            ...
            input4_val = _mm512_mask_mov_epi32(input8_val, _mm512_cmp_epi32_mask(tmp_input4, inputCopy, _MM_CMPINT_EQ),
                                               input4_val_copy);
            input8_val = _mm512_mask_mov_epi32(input4_val_copy,
                                               _mm512_cmp_epi32_mask(tmp_input8, input8, _MM_CMPINT_EQ),
                                               input8_val);
    ...
    inline void CoreSmallSort9(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                               __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                               __m512 &input9,
                               __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                               __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val,
        ...
        CoreSmallSort(input9, input9_val);
        {
            ...
            input9_val = _mm512_mask_mov_epi32(input8_val, _mm512_cmp_epi32_mask(tmp_input9, permNeigh9, _MM_CMPINT_EQ),
                                               input9_val_perm);
            input8_val = _mm512_mask_mov_epi32(input9_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input8, input8, _MM_CMPINT_EQ),
                                               input8_val);
    ...
    inline void CoreSmallSort9(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input6 = _mm512_loadu_ps(ptr1 + 6 * 16);
        __m512 input7 = _mm512_loadu_ps(ptr1 + 7 * 16);
        __m512 input8 = _mm512_loadu_ps(ptr1 + 8 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        _mm512_storeu_ps(ptr1 + 6 * 16, input6);
        _mm512_storeu_ps(ptr1 + 7 * 16, input7);
        _mm512_storeu_ps(ptr1 + 8 * 16, input8);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort10(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                                __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                                __m512 &input9, __m512 &input10,
                                __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                                __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val,
        ...
        CoreSmallSort2(input9, input10, input9_val, input10_val);
        {
            ...
            input10_val = _mm512_mask_mov_epi32(input7_val,
                                                _mm512_cmp_epi32_mask(tmp_input10, permNeigh10, _MM_CMPINT_EQ),
                                                input10_val_perm);
            input7_val = _mm512_mask_mov_epi32(input10_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input7, input7, _MM_CMPINT_EQ),
                                               input7_val);
    ...
    inline void CoreSmallSort10(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input7 = _mm512_loadu_ps(ptr1 + 7 * 16);
        __m512 input8 = _mm512_loadu_ps(ptr1 + 8 * 16);
        __m512 input9 = _mm512_loadu_ps(ptr1 + 9 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        _mm512_storeu_ps(ptr1 + 7 * 16, input7);
        _mm512_storeu_ps(ptr1 + 8 * 16, input8);
        _mm512_storeu_ps(ptr1 + 9 * 16, input9);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort11(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                                __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                                __m512 &input9, __m512 &input10, __m512 &input11,
                                __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                                __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val,
                       ...
                       input9_val, input10_val, input11_val);
        {
            ...
            input11_val = _mm512_mask_mov_epi32(input6_val,
                                                _mm512_cmp_epi32_mask(tmp_input11, permNeigh11, _MM_CMPINT_EQ),
                                                input11_val_perm);
            input6_val = _mm512_mask_mov_epi32(input11_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input6, input6, _MM_CMPINT_EQ),
                                               input6_val);
    ...
    inline void CoreSmallSort11(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input8 = _mm512_loadu_ps(ptr1 + 8 * 16);
        __m512 input9 = _mm512_loadu_ps(ptr1 + 9 * 16);
        __m512 input10 = _mm512_loadu_ps(ptr1 + 10 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        _mm512_storeu_ps(ptr1 + 8 * 16, input8);
        _mm512_storeu_ps(ptr1 + 9 * 16, input9);
        _mm512_storeu_ps(ptr1 + 10 * 16, input10);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort12(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                                __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                                __m512 &input9, __m512 &input10, __m512 &input11, __m512 &input12,
                                __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                                __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val,
                                __m512i &input9_val, __m512i &input10_val, __m512i &input11_val,
                                __m512i &input12_val) {
                       ...
                       input9_val, input10_val, input11_val, input12_val);
        {
            ...
            input12_val = _mm512_mask_mov_epi32(input5_val,
                                                _mm512_cmp_epi32_mask(tmp_input12, permNeigh12, _MM_CMPINT_EQ),
                                                input12_val_perm);
            input5_val = _mm512_mask_mov_epi32(input12_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input5, input5, _MM_CMPINT_EQ),
                                               input5_val);
    ...
    inline void CoreSmallSort12(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input9 = _mm512_loadu_ps(ptr1 + 9 * 16);
        __m512 input10 = _mm512_loadu_ps(ptr1 + 10 * 16);
        __m512 input11 = _mm512_loadu_ps(ptr1 + 11 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        CoreSmallSort12(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10,
                        input11,
                        input0_val, input1_val, input2_val, input3_val, input4_val, input5_val, input6_val, input7_val,
        ...
        _mm512_storeu_ps(ptr1 + 9 * 16, input9);
        _mm512_storeu_ps(ptr1 + 10 * 16, input10);
        _mm512_storeu_ps(ptr1 + 11 * 16, input11);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort13(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                                __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                                __m512 &input9, __m512 &input10, __m512 &input11, __m512 &input12,
                                __m512 &input13,
                                __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                       ...
                       input9_val, input10_val, input11_val, input12_val, input13_val);
        {
            ...
            input13_val = _mm512_mask_mov_epi32(input4_val,
                                                _mm512_cmp_epi32_mask(tmp_input13, permNeigh13, _MM_CMPINT_EQ),
                                                input13_val_perm);
            input4_val = _mm512_mask_mov_epi32(input13_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input4, input4, _MM_CMPINT_EQ),
                                               input4_val);
    ...
    inline void CoreSmallSort13(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input10 = _mm512_loadu_ps(ptr1 + 10 * 16);
        __m512 input11 = _mm512_loadu_ps(ptr1 + 11 * 16);
        __m512 input12 = _mm512_loadu_ps(ptr1 + 12 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        CoreSmallSort13(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10,
                        input11, input12,
                        input0_val, input1_val, input2_val, input3_val, input4_val, input5_val, input6_val, input7_val,
                        input8_val, input9_val, input10_val, input11_val, input12_val);
        _mm512_storeu_ps(ptr1 + 0 * 16, input0);
        _mm512_storeu_ps(ptr1 + 1 * 16, input1);
        _mm512_storeu_ps(ptr1 + 2 * 16, input2);
        _mm512_storeu_ps(ptr1 + 3 * 16, input3);
        ...
        _mm512_storeu_ps(ptr1 + 10 * 16, input10);
        _mm512_storeu_ps(ptr1 + 11 * 16, input11);
        _mm512_storeu_ps(ptr1 + 12 * 16, input12);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort14(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                                __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                                __m512 &input9, __m512 &input10, __m512 &input11, __m512 &input12,
                                __m512 &input13, __m512 &input14,
                                __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                                __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val,
                                __m512i &input9_val, __m512i &input10_val, __m512i &input11_val,
                       ...
                       input9_val, input10_val, input11_val, input12_val, input13_val, input14_val);
        {
            ...
            input14_val = _mm512_mask_mov_epi32(input3_val,
                                                _mm512_cmp_epi32_mask(tmp_input14, permNeigh14, _MM_CMPINT_EQ),
                                                input14_val_perm);
            input3_val = _mm512_mask_mov_epi32(input14_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input3, input3, _MM_CMPINT_EQ),
                                               input3_val);
    ...
    inline void CoreSmallSort14(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input11 = _mm512_loadu_ps(ptr1 + 11 * 16);
        __m512 input12 = _mm512_loadu_ps(ptr1 + 12 * 16);
        __m512 input13 = _mm512_loadu_ps(ptr1 + 13 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        CoreSmallSort14(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10,
                        input11, input12, input13,
                        input0_val, input1_val, input2_val, input3_val, input4_val, input5_val, input6_val, input7_val,
                        input8_val, input9_val, input10_val, input11_val, input12_val, input13_val);
        _mm512_storeu_ps(ptr1 + 0 * 16, input0);
        _mm512_storeu_ps(ptr1 + 1 * 16, input1);
        _mm512_storeu_ps(ptr1 + 2 * 16, input2);
        _mm512_storeu_ps(ptr1 + 3 * 16, input3);
        ...
        _mm512_storeu_ps(ptr1 + 11 * 16, input11);
        _mm512_storeu_ps(ptr1 + 12 * 16, input12);
        _mm512_storeu_ps(ptr1 + 13 * 16, input13);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort15(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                                __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                                __m512 &input9, __m512 &input10, __m512 &input11, __m512 &input12,
                                __m512 &input13, __m512 &input14, __m512 &input15,
                                __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                                __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val,
                                __m512i &input9_val, __m512i &input10_val, __m512i &input11_val,
                                __m512i &input12_val, __m512i &input13_val, __m512i &input14_val,
                       ...
                       input9_val, input10_val, input11_val, input12_val, input13_val, input14_val, input15_val);
        {
            ...
            input15_val = _mm512_mask_mov_epi32(input2_val,
                                                _mm512_cmp_epi32_mask(tmp_input15, permNeigh15, _MM_CMPINT_EQ),
                                                input15_val_perm);
            input2_val = _mm512_mask_mov_epi32(input15_val_perm,
                                               _mm512_cmp_epi32_mask(tmp_input2, input2, _MM_CMPINT_EQ),
                                               input2_val);
    ...
    inline void CoreSmallSort15(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0 = _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input12 = _mm512_loadu_ps(ptr1 + 12 * 16);
        __m512 input13 = _mm512_loadu_ps(ptr1 + 13 * 16);
        __m512 input14 = _mm512_loadu_ps(ptr1 + 14 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        CoreSmallSort15(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10,
                        input11, input12, input13, input14,
                        input0_val, input1_val, input2_val, input3_val, input4_val, input5_val, input6_val, input7_val,
                        input8_val, input9_val, input10_val, input11_val, input12_val, input13_val, input14_val);
        _mm512_storeu_ps(ptr1 + 0 * 16, input0);
        _mm512_storeu_ps(ptr1 + 1 * 16, input1);
        _mm512_storeu_ps(ptr1 + 2 * 16, input2);
        _mm512_storeu_ps(ptr1 + 3 * 16, input3);
        ...
        _mm512_storeu_ps(ptr1 + 12 * 16, input12);
        _mm512_storeu_ps(ptr1 + 13 * 16, input13);
        _mm512_storeu_ps(ptr1 + 14 * 16, input14);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void CoreSmallSort16(__m512 &input, __m512 &input2, __m512 &input3, __m512 &input4,
                                __m512 &input5, __m512 &input6, __m512 &input7, __m512 &input8,
                                __m512 &input9, __m512 &input10, __m512 &input11, __m512 &input12,
                                __m512 &input13, __m512 &input14, __m512 &input15, __m512 &input16,
                                __m512i &input_val, __m512i &input2_val, __m512i &input3_val, __m512i &input4_val,
                                __m512i &input5_val, __m512i &input6_val, __m512i &input7_val, __m512i &input8_val,
                                __m512i &input9_val, __m512i &input10_val, __m512i &input11_val,
                                __m512i &input12_val, __m512i &input13_val, __m512i &input14_val,
        ...
        CoreSmallSort8(input9, input10, input11, input12, input13, input14, input15, input16,
                       ...
                       input16_val);
        {
            __m512i idxNoNeigh = _mm512_set_epi32(0, 1, 2, 3, 4, 5, 6, 7, // TODO: wtf is this
                                                  8, 9, 10, 11, 12, 13, 14, 15);
            __m512i permNeigh9 = _mm512_permutexvar_epi32(idxNoNeigh, input9);
            __m512i permNeigh10 = _mm512_permutexvar_epi32(idxNoNeigh, input10);
            __m512i permNeigh11 = _mm512_permutexvar_epi32(idxNoNeigh, input11);
            ...
            input16_val = _mm512_mask_mov_epi32(input_val,
                                                _mm512_cmp_epi32_mask(tmp_input16, permNeigh16, _MM_CMPINT_EQ),
                                                input16_val_perm);
    ...
    inline void CoreSmallSort16(float *__restrict__ ptr1, int *__restrict__ values) {
        __m512 input0= _mm512_loadu_ps(ptr1 + 0 * 16);
        __m512 input1 = _mm512_loadu_ps(ptr1 + 1 * 16);
        __m512 input2 = _mm512_loadu_ps(ptr1 + 2 * 16);
        __m512 input3 = _mm512_loadu_ps(ptr1 + 3 * 16);
        ...
        __m512 input13 = _mm512_loadu_ps(ptr1 + 13 * 16);
        __m512 input14 = _mm512_loadu_ps(ptr1 + 14 * 16);
        __m512 input15 = _mm512_loadu_ps(ptr1 + 15 * 16);
        __m512i input0_val = _mm512_loadu_si512(values + 0 * 16);
        __m512i input1_val = _mm512_loadu_si512(values + 1 * 16);
        __m512i input2_val = _mm512_loadu_si512(values + 2 * 16);
        __m512i input3_val = _mm512_loadu_si512(values + 3 * 16);
        ...
        CoreSmallSort16(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10,
        ...
        _mm512_storeu_ps(ptr1 + 13 * 16, input13);
        _mm512_storeu_ps(ptr1 + 14 * 16, input14);
        _mm512_storeu_ps(ptr1 + 15 * 16, input15);
        _mm512_storeu_si512(values + 0 * 16, input0_val);
        _mm512_storeu_si512(values + 1 * 16, input1_val);
        _mm512_storeu_si512(values + 2 * 16, input2_val);
        _mm512_storeu_si512(values + 3 * 16, input3_val);
    ...
    inline void SmallSort16V(float *__restrict__ ptr, int *__restrict__ values, const size_t length) {
        ...
        switch (nbVecs) {
            case 1: {
                __m512 v1 = _mm512_or_si512(_mm512_maskz_loadu_ps(0xFFFF >> rest, ptr),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, FLT_MAX)); // TODO: find equiv instruction
                ...
                _mm512_mask_compressstoreu_ps(ptr, 0xFFFF >> rest, v1);
                _mm512_mask_compressstoreu_epi32(values, 0xFFFF >> rest, v1_val);
            }
                break;
            case 2: {
                __m512 v1 = _mm512_loadu_ps(ptr);
                __m512i v1_val = _mm512_loadu_si512(values);
                __m512 v2 = _mm512_or_si512(_mm512_maskz_loadu_ps(0xFFFF >> rest, ptr + 16),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, FLT_MAX)); // TODO: here too
                __m512i v2_val = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, values + 16),
                                                 _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                CoreSmallSort2(v1, v2,
                               v1_val, v2_val);
                _mm512_storeu_ps(ptr, v1);
                _mm512_storeu_si512(values, v1_val);
                _mm512_mask_compressstoreu_ps(ptr + 16, 0xFFFF >> rest, v2);
            ...
            case 3: {
                __m512 v1 = _mm512_loadu_ps(ptr);
                __m512i v1_val = _mm512_loadu_si512(values);
                __m512 v2 = _mm512_loadu_ps(ptr + 16);
                __m512i v2_val = _mm512_loadu_si512(values + 16);
                __m512 v3 = _mm512_or_ps(_mm512_maskz_loadu_ps(0xFFFF >> rest, ptr + 32),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX)); // TODO
                ...
                _mm512_storeu_ps(ptr, v1);
                _mm512_storeu_si512(values, v1_val);
                _mm512_storeu_ps(ptr + 16, v2);
                _mm512_storeu_si512(values + 16, v2_val);
                _mm512_mask_compressstoreu_ps(ptr + 32, 0xFFFF >> rest, v3);
            ...
            case 4: {
                ...
                __m512 v2 = _mm512_loadu_ps(ptr + 16);
                __m512i v2_val = _mm512_loadu_si512(values + 16);
                __m512 v3 = _mm512_loadu_ps(ptr + 32);
                __m512i v3_val = _mm512_loadu_si512(values + 32);
                __m512 v4 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 48),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 16, v2);
                _mm512_storeu_si512(values + 16, v2_val);
                _mm512_storeu_ps(ptr + 32, v3);
                _mm512_storeu_si512(values + 32, v3_val);
                _mm512_mask_compressstoreu_ps(ptr + 48, 0xFFFF >> rest, v4);
            ...
            case 5: {
                ...
                __m512 v3 = _mm512_loadu_ps(ptr + 32);
                __m512i v3_val = _mm512_loadu_si512(values + 32);
                __m512 v4 = _mm512_loadu_ps(ptr + 48);
                __m512i v4_val = _mm512_loadu_si512(values + 48);
                __m512 v5 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 64),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 32, v3);
                _mm512_storeu_si512(values + 32, v3_val);
                _mm512_storeu_ps(ptr + 48, v4);
                _mm512_storeu_si512(values + 48, v4_val);
                _mm512_mask_compressstoreu_ps(ptr + 64, 0xFFFF >> rest, v5);
            ...
            case 6: {
                ...
                __m512 v4 = _mm512_loadu_ps(ptr + 48);
                __m512i v4_val = _mm512_loadu_si512(values + 48);
                __m512 v5 = _mm512_loadu_ps(ptr + 64);
                __m512i v5_val = _mm512_loadu_si512(values + 64);
                __m512 v6 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 80),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 48, v4);
                _mm512_storeu_si512(values + 48, v4_val);
                _mm512_storeu_ps(ptr + 64, v5);
                _mm512_storeu_si512(values + 64, v5_val);
                _mm512_mask_compressstoreu_ps(ptr + 80, 0xFFFF >> rest, v6);
            ...
            case 7: {
                ...
                __m512 v5 = _mm512_loadu_ps(ptr + 64);
                __m512i v5_val = _mm512_loadu_si512(values + 64);
                __m512 v6 = _mm512_loadu_ps(ptr + 80);
                __m512i v6_val = _mm512_loadu_si512(values + 80);
                __m512 v7 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 96),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 64, v5);
                _mm512_storeu_si512(values + 64, v5_val);
                _mm512_storeu_ps(ptr + 80, v6);
                _mm512_storeu_si512(values + 80, v6_val);
                _mm512_mask_compressstoreu_ps(ptr + 96, 0xFFFF >> rest, v7);
            ...
            case 8: {
                ...
                __m512 v6 = _mm512_loadu_ps(ptr + 80);
                __m512i v6_val = _mm512_loadu_si512(values + 80);
                __m512 v7 = _mm512_loadu_ps(ptr + 96);
                __m512i v7_val = _mm512_loadu_si512(values + 96);
                __m512 v8 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 112),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 80, v6);
                _mm512_storeu_si512(values + 80, v6_val);
                _mm512_storeu_ps(ptr + 96, v7);
                _mm512_storeu_si512(values + 96, v7_val);
                _mm512_mask_compressstoreu_ps(ptr + 112, 0xFFFF >> rest, v8);
            ...
            case 9: {
                ...
                __m512 v7 = _mm512_loadu_ps(ptr + 96);
                __m512i v7_val = _mm512_loadu_si512(values + 96);
                __m512 v8 = _mm512_loadu_ps(ptr + 112);
                __m512i v8_val = _mm512_loadu_si512(values + 112);
                __m512 v9 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 128),
                                             _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 96, v7);
                _mm512_storeu_si512(values + 96, v7_val);
                _mm512_storeu_ps(ptr + 112, v8);
                _mm512_storeu_si512(values + 112, v8_val);
                _mm512_mask_compressstoreu_ps(ptr + 128, 0xFFFF >> rest, v9);
            ...
            case 10: {
                ...
                __m512 v8 = _mm512_loadu_ps(ptr + 112);
                __m512i v8_val = _mm512_loadu_si512(values + 112);
                __m512 v9 = _mm512_loadu_ps(ptr + 128);
                __m512i v9_val = _mm512_loadu_si512(values + 128);
                __m512 v10 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 144),
                                              _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 112, v8);
                _mm512_storeu_si512(values + 112, v8_val);
                _mm512_storeu_ps(ptr + 128, v9);
                _mm512_storeu_si512(values + 128, v9_val);
                _mm512_mask_compressstoreu_ps(ptr + 144, 0xFFFF >> rest, v10);
            ...
            case 11: {
                ...
                __m512 v9 = _mm512_loadu_ps(ptr + 128);
                __m512i v9_val = _mm512_loadu_si512(values + 128);
                __m512 v10 = _mm512_loadu_ps(ptr + 144);
                __m512i v10_val = _mm512_loadu_si512(values + 144);
                __m512 v11 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 160),
                                              _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 128, v9);
                _mm512_storeu_si512(values + 128, v9_val);
                _mm512_storeu_ps(ptr + 144, v10);
                _mm512_storeu_si512(values + 144, v10_val);
                _mm512_mask_compressstoreu_ps(ptr + 160, 0xFFFF >> rest, v11);
            ...
            case 12: {
                ...
                __m512 v10 = _mm512_loadu_ps(ptr + 144);
                __m512i v10_val = _mm512_loadu_si512(values + 144);
                __m512 v11 = _mm512_loadu_ps(ptr + 160);
                __m512i v11_val = _mm512_loadu_si512(values + 160);
                __m512 v12 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 176),
                                              _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 144, v10);
                _mm512_storeu_si512(values + 144, v10_val);
                _mm512_storeu_ps(ptr + 160, v11);
                _mm512_storeu_si512(values + 160, v11_val);
                _mm512_mask_compressstoreu_ps(ptr + 176, 0xFFFF >> rest, v12);
            ...
            case 13: {
                ...
                __m512 v11 = _mm512_loadu_ps(ptr + 160);
                __m512i v11_val = _mm512_loadu_si512(values + 160);
                __m512 v12 = _mm512_loadu_ps(ptr + 176);
                __m512i v12_val = _mm512_loadu_si512(values + 176);
                __m512 v13 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 192),
                                              _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                _mm512_storeu_ps(ptr + 160, v11);
                _mm512_storeu_si512(values + 160, v11_val);
                _mm512_storeu_ps(ptr + 176, v12);
                _mm512_storeu_si512(values + 176, v12_val);
                _mm512_mask_compressstoreu_ps(ptr + 192, 0xFFFF >> rest, v13);
            ...
            case 14: {
                ...
                __m512 v12 = _mm512_loadu_ps(ptr + 176);
                __m512i v12_val = _mm512_loadu_si512(values + 176);
                __m512 v13 = _mm512_loadu_ps(ptr + 192);
                __m512i v13_val = _mm512_loadu_si512(values + 192);
                __m512 v14 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 208),
                                              _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                CoreSmallSort14(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14,
                                v1_val, v2_val, v3_val, v4_val, v5_val, v6_val, v7_val, v8_val, v9_val, v10_val,
                                v11_val, v12_val, v13_val, v14_val);
                _mm512_storeu_ps(ptr, v1);
                _mm512_storeu_si512(values, v1_val);
                _mm512_storeu_ps(ptr + 16, v2);
                _mm512_storeu_si512(values + 16, v2_val);
                ...
                _mm512_storeu_ps(ptr + 176, v12);
                _mm512_storeu_si512(values + 176, v12_val);
                _mm512_storeu_ps(ptr + 192, v13);
                _mm512_storeu_si512(values + 192, v13_val);
                _mm512_mask_compressstoreu_ps(ptr + 208, 0xFFFF >> rest, v14);
            ...
            case 15: {
                ...
                __m512 v13 = _mm512_loadu_ps(ptr + 192);
                __m512i v13_val = _mm512_loadu_si512(values + 192);
                __m512 v14 = _mm512_loadu_ps(ptr + 208);
                __m512i v14_val = _mm512_loadu_si512(values + 208);
                __m512 v15 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 224),
                                              _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                CoreSmallSort15(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15,
                                v1_val, v2_val, v3_val, v4_val, v5_val, v6_val, v7_val, v8_val, v9_val, v10_val,
                                v11_val, v12_val, v13_val, v14_val, v15_val);
                _mm512_storeu_ps(ptr, v1);
                _mm512_storeu_si512(values, v1_val);
                _mm512_storeu_ps(ptr + 16, v2);
                _mm512_storeu_si512(values + 16, v2_val);
                ...
                _mm512_storeu_ps(ptr + 192, v13);
                _mm512_storeu_si512(values + 192, v13_val);
                _mm512_storeu_ps(ptr + 208, v14);
                _mm512_storeu_si512(values + 208, v14_val);
                _mm512_mask_compressstoreu_ps(ptr + 224, 0xFFFF >> rest, v15);
            ...
            default: {
                ...
                __m512 v14 = _mm512_loadu_ps(ptr + 208);
                __m512i v14_val = _mm512_loadu_si512(values + 208);
                __m512 v15 = _mm512_loadu_ps(ptr + 224);
                __m512i v15_val = _mm512_loadu_si512(values + 224);
                __m512 v16 = _mm512_or_si512(_mm512_maskz_loadu_epi32(0xFFFF >> rest, ptr + 240),
                                              _mm512_maskz_set1_epi32(0xFFFF << lastVecSize, INT_MAX));
                ...
                CoreSmallSort16(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16,
                                v1_val, v2_val, v3_val, v4_val, v5_val, v6_val, v7_val, v8_val, v9_val, v10_val,
                                v11_val, v12_val, v13_val, v14_val, v15_val, v16_val);
                _mm512_storeu_ps(ptr, v1);
                _mm512_storeu_si512(values, v1_val);
                _mm512_storeu_ps(ptr + 16, v2);
                _mm512_storeu_si512(values + 16, v2_val);
                ...
                _mm512_storeu_ps(ptr + 208, v14);
                _mm512_storeu_si512(values + 208, v14_val);
                _mm512_storeu_ps(ptr + 224, v15);
                _mm512_storeu_si512(values + 224, v15_val);
                _mm512_mask_compressstoreu_ps(ptr + 240, 0xFFFF >> rest, v16);
...
/* a sequential qs */
    ...
    static inline IndexType Partition512(float array[], int values[], IndexType left, IndexType right,
                                         const int pivot) {
        ...
        __m512 left_val = _mm512_loadu_ps(&array[left]);
        ...
        right -= S - 1;
        __m512i right_val = _mm512_loadu_ps(&array[right]);
        ...
        while (left + S <= right) {
            ...
            if (free_left <= free_right) {
                val = _mm512_loadu_ps(&array[left]);
                val_val = _mm512_loadu_si512(&values[left]);
                left += S;
            } else {
                right -= S;
                val = _mm512_loadu_ps(&array[right]);
...

        {
            ...
            __m512i val = _mm512_loadu_ps(&array[left]);
...
////////////////////////////////////////////////////////////////////////////////
    ...
    CoreSortPivotPartition(SortType array[], SortType values[], const IndexType left, const IndexType right) {
        if (right - left > 1) {
    ...
    template<class SortType, class IndexType = size_t>
    static inline IndexType
    CoreSortPartition(SortType array[], SortType values[], const IndexType left, const IndexType right,
                      const SortType pivot) {
